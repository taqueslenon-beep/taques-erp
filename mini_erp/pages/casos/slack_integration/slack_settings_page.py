...
def slack_settings_page():
    ...
    # CORREÇÃO: Usar "with layout()" para garantir renderização correta da sidebar
    with layout('Configurações Slack'):
        # CORREÇÃO: Removido mx-auto e max-w-4xl para aproveitar melhor o espaço
        # Título removido - já vem do layout('Configurações Slack')
        with ui.column().classes('w-full p-4 gap-6'):
            ui.label('Configure sua conta Slack para exibir mensagens nos casos jurídicos.').classes('text-gray-600 mb-6 -mt-2')
